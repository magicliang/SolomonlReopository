package com.solomonl.classloader;
...
public class ClassLoaderTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
         * Try to use com.solomonl.classloader.CompileClassLoader to load myself's hello method.
         ...
         */
        //com.solomonl.classloader.CompileClassLoader compileClassLoader = new com.solomonl.classloader.CompileClassLoader(null);
        CompileClassLoader compileClassLoader = new CompileClassLoader();
        // 这是在用现成的父加载器加载这个类，注意，这个类因为 main 已经跑到这里了，必然在类加载器缓存里。
        // 一定要加完整限定名。
        Class<?> clazz = compileClassLoader.loadClass("com.solomonl.classloader.ClassLoaderTest");
        ...
        clazz = urlClassLoader.loadClass("com.solomonl.classloader.ClassLoaderTest");

        hello = clazz.getMethod("hello");
        hello.invoke(null, null);

        IExample iExample = (IExample) (urlClassLoader.loadClass("com.solomonl.classloader.IExample")).newInstance();
        System.out.println(
...
class CompileClassLoader extends ClassLoader {
    ...
    private boolean compile(String javaFile) throws IOException {
        System.out.println("com.solomonl.classloader.CompileClassLoader：正在编译 " + javaFile + "...");
